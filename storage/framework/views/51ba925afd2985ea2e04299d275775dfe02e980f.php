        ...
        <div id="carouselExampleIndicators" class="carousel slide"  data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100 slide-pic" src="<?php echo e(asset('images/img1.jpg')); ?>" alt="First slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100 slide-pic" src="<?php echo e(asset('images/img2.jpg')); ?>" alt="Second slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100 slide-pic" src="<?php echo e(asset('images/img3.jpg')); ?>" alt="Third slide">
                </div>
            </div>
